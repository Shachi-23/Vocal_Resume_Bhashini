  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="flex flex-col items-center justify-center min-h-[calc(100vh-120px)] px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Choose Your Language</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {indianLanguages.map((language) => (
              <Button
                ...
                variant="outline"
                className={`
                  h-28 px-6 py-4 flex flex-col items-center justify-center space-y-2
                  ...
                  ${selectedLanguage === language.code ? "bg-blue-50 border-blue-400 text-blue-900" : ""}
                `}
                onClick={() => handleLanguageSelect(language.code)}
              >
          ...
          {/* Additional Info */}
          <div className="mt-16 bg-gray-50 rounded-lg p-8 max-w-2xl mx-auto border border-gray-200">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900">Voice Recording in Your Language</h3>
            </div>
